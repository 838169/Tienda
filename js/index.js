...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const productos = [
        ...
        { id: 'max', nombre: 'Max', descripcion: ['Contenido premium de HBO y Warner Bros.', 'Series del universo DC y Cartoon Network', 'Calidad de imagen hasta 4K UHD'], iconoHtml: `<img src="/Tienda/img/max.avif" alt="Max"/>`, claseColor: 'max', soloIcono: true, disclaimer: 'La suscripción puede ser Básico, Standard o Platino.', opciones: [{ etiqueta: '1 Pantalla' }, { etiqueta: '2 Pantallas' }, { etiqueta: '3 Pantallas' }] },
        ...
        { id: 'paramount', nombre: 'Paramount+', descripcion: ['Contenido exclusivo de Showtime y CBS', 'Eventos deportivos como la Champions League', 'Catálogo para todas las edades'], iconoHtml: `<img src="/Tienda/img/Paramount_Plus.svg" alt="Paramount+"/>`, claseColor: 'paramount', soloIcono: false, opciones: [{ etiqueta: '1 Pantalla' }, { etiqueta: '2 Pantallas' }, { etiqueta: '3 Pantallas' }] },
        { id: 'vix', nombre: 'Vix Premium', descripcion: ['El mejor contenido en español sin anuncios', 'Deportes en vivo como LaLiga española', 'Series y novelas originales'], iconoHtml: `<img src="/Tienda/img/vix.webp" alt="Vix Premium" class="logo-redondeado"/>`, claseColor: 'vix', soloIcono: false, opciones: [{ etiqueta: '1 Pantalla' }, { etiqueta: '2 Pantallas' }, { etiqueta: '3 Pantallas' }] },
        { id: 'deezer', nombre: 'Deezer', descripcion: ['Música en alta fidelidad (FLAC)', 'Música y podcasts sin interrupciones', 'Identificador de canciones SongCatcher'], iconoHtml: `<img src="/Tienda/img/deezer.webp" alt="Deezer" class="logo-redondeado"/>`, claseColor: 'deezer', soloIcono: false, opciones: [{ etiqueta: '1 Mes' }, { etiqueta: '2 Meses' }, { etiqueta: '3 Meses' }, { etiqueta: '4 Meses' }, { etiqueta: '5 Meses' }] },
        { id: 'gemini', nombre: 'Gemini Pro', descripcion: ['Acceso a los modelos de IA más potentes', 'Integrado en Gmail, Documentos y más', '2 TB de almacenamiento en la nube'], iconoHtml: `<img src="/Tienda/img/Gemini_Pro.webp" alt="Gemini Pro" class="logo-redondeado"/>`, claseColor: 'gemini', soloIcono: false, opciones: [{ etiqueta: '1 Mes' }] },
        ...
        { id: 'iptv', nombre: 'IPTV', descripcion: ['Acceso a canales de TV en vivo', 'Películas, series y deportes a la carta', 'Contenido de múltiples plataformas integradas'], iconoHtml: `<img src="/Tienda/img/iptv.jpg" alt="IPTV"/>`, claseColor: 'iptv', soloIcono: false, opciones: [{ etiqueta: '1 Pantalla' }] },
        { id: 'profe-net', nombre: 'El Profe Net', descripcion: ['Más de 60 canales deportivos', 'Fútbol, Fórmula 1, UFC y más', 'Transmisiones en alta definición'], iconoHtml: `<img src="/Tienda/img/elprofenet.png" alt="El Profe Net"/>`, claseColor: 'profe-net', soloIcono: false, opciones: [{ etiqueta: 'Acceso Total' }] },
        { id: 'apple-tv', nombre: 'Apple TV+', descripcion: ['Contenido Apple Originals exclusivo', 'Series aclamadas como "Ted Lasso" y "Severance"', 'Películas ganadoras de premios'], iconoHtml: `<img src="/Tienda/img/appletv.webp"/>`, claseColor: 'apple-tv', soloIcono: false, opciones: [{ etiqueta: 'Suscripción Mensual' }] },
    ];

    const combos = [
        { id: 'combo-tv', nombre: 'Combo TV', iconos: ['<img src="/Tienda/img/Disney.png"', 'https://img.icons8.com/color/48/netflix.png', '/Tienda/img/vix.webp'], claseColor: 'combo', caracteristicas: ['Disney+ Standard', 'Netflix', 'Vix'] },
        ...
        { id: 'combo-mix', nombre: 'Combo Mix', iconos: ['https://img.icons8.com/color/48/spotify.png', 'https://img.icons8.com/color/48/netflix.png', '/Tienda/img/Disney.png'], claseColor: 'combo', caracteristicas: ['Spotify 1 Mes', 'Netflix', 'Disney+ Standard'] },
        { id: 'combo-familiar-plus', nombre: 'Combo Familiar Plus', iconos: ['/Tienda/img/deezer.webp', '/Tienda/img/Disney.png', '/Tienda/img/Paramount_Plus.svg', 'https://img.icons8.com/color/48/netflix.png'], claseColor: 'combo', caracteristicas: ['Deezer 5 Meses', 'Disney+ Standard', 'Paramount+', 'Netflix'] },
        { id: 'combo-deportes-familia', nombre: 'Combo Deportes y Familia', iconos: ['/Tienda/img/vix.webp', 'https://img.icons8.com/color/48/amazon-prime-video.png', '/img/Disney.png'], claseColor: 'combo', caracteristicas: ['Vix', 'Prime Video', 'Disney+ Standard'] },
        { id: 'combo-premium-mix', nombre: 'Combo Premium Mix', iconos: ['/Tienda/img/Disney.png', '/Tienda/img/max.avif', 'https://img.icons8.com/color/48/spotify.png'], claseColor: 'combo', caracteristicas: ['Disney+ Premium', 'Max', 'Spotify 3 Meses'] },
        { id: 'combo-latino', nombre: 'Combo Latino', iconos: ['/Tienda/img/deezer.webp', '/Tienda/img/Disney.png', '/Tienda/img/vix.webp', '/Tienda/img/max.avif'], claseColor: 'combo', caracteristicas: ['Deezer 1 Mes', 'Disney+ Standard', 'Vix', 'Max'] },
        { id: 'combo-productividad', nombre: 'Combo Productividad', iconos: ['/Tienda/img/Gemini_Pro.webp', '/Tienda/img/deezer.webp', '/Tienda/img/vix.webp'], claseColor: 'combo', caracteristicas: ['Gemini Pro', 'Deezer 1 Mes', 'Vix'] },
        { id: 'combo-deportes-total', nombre: 'Combo Deportes Total', iconos: ['/Tienda/img/elprofenet.png', '/Tienda/img/Disney.png'], claseColor: 'combo', caracteristicas: ['El Profe Net', 'Disney+ Standard (con ESPN)'] },
        { id: 'combo-cine-premium', nombre: 'Combo Cine Premium', iconos: ['/Tienda/img/appletv.webp', 'https://img.icons8.com/color/96/hulu.png', '/img/max.avif'], claseColor: 'combo', caracteristicas: ['Apple TV+', 'Hulu', 'Max'] },
        { id: 'combo-tv-global', nombre: 'Combo TV Global', iconos: ['/Tienda/img/iptv.jpg', 'https://img.icons8.com/color/48/netflix.png'], claseColor: 'combo', caracteristicas: ['IPTV', 'Netflix'] },
        { id: 'combo-usa-entretenimiento', nombre: 'Combo USA Entretenimiento', iconos: ['https://img.icons8.com/color/96/hulu.png', '/Tienda/img/max.avif'], claseColor: 'combo', caracteristicas: ['Hulu', 'Max'] },
    ];
